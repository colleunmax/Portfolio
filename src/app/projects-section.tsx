...
export default function Projects() {
    ...
    return <section className="flex flex-col gap-6 row-span-2 intermediate-md:bg-secondary-background intermediate-md:p-6 intermediate-md:rounded-md intermediate-md:h-[600px] intermediate-md:text-ternary" id="projects">
